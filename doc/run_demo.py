import sys
from demos.chain_expression_demos import create_chain_expression_demo, create_chain_expression_demo_with_queue_line, create_filter_window_avg_meet_demo, create_count_equal_chain_demo
...
AVAILABLE_DEMOS = {
    ...
    "count_equal_chain": create_count_equal_chain_demo,
