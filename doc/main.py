...
def create_chain_expression_demo():
    ...
    """
    state_pairs = [
        # Sequence 1: Values filtered out
        StateTransitionPair("6", "false", "6∉(-5,5)|FILTERED OUT", False),
        StateTransitionPair("-6", "false", "-6∉(-5,5)|FILTERED OUT", False),

        # Sequence 2: Building up the queue
        ...
        # Sequence 3: Queue continues to grow
        ...
        # Sequence 4: Queue limit exceeded - FIFO behavior
        ...
        # Sequence 5: Recovery - condition met again
        StateTransitionPair("3", "true", "3∈(-5,5)|Queue:[0,4,-1,-2,3]|Take:[0,4]|Sum:4|4>1✓", True),

        # Sequence 6: More examples showing the pipeline
