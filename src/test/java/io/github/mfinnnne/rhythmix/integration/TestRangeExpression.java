...
public class TestRangeExpression {
    ...
    void testProductWeightQualifiedRange() throws TranslatorException {
        ...
        Assertions.assertTrue(rhythmixExecutor.execute(productData1));
        ...
        Assertions.assertTrue(rhythmixExecutor.execute(productData2));
        ...
        Assertions.assertTrue(rhythmixExecutor.execute(productData3));
        ...
        Assertions.assertTrue(rhythmixExecutor.execute(productData4));
        ...
        Assertions.assertFalse(rhythmixExecutor.execute(productData5));

        // 测试超出范围110克，应该返回false
        RhythmixEventData productData6 = Util.genEventData("product6", "110", new Timestamp(System.currentTimeMillis()));
        Assertions.assertFalse(rhythmixExecutor.execute(productData6));
    }
    ...
    void testProductSizePrecisionRange() throws TranslatorException {
        ...
        Assertions.assertFalse(rhythmixExecutor.execute(productData4));
        ...
        Assertions.assertFalse(rhythmixExecutor.execute(productData7));
    }
    ...
    void testConsecutiveQualifiedProducts() throws TranslatorException {
        ...
        for (RhythmixEventData product : products) {
            result = rhythmixExecutor.execute(product);
        }
    ...
    void testNormalResponseTimeRange() throws TranslatorException {
        ...
        Assertions.assertTrue(rhythmixExecutor.execute(responseData1));
        ...
        Assertions.assertTrue(rhythmixExecutor.execute(responseData2));
        ...
        Assertions.assertTrue(rhythmixExecutor.execute(responseData3));
        ...
        Assertions.assertFalse(rhythmixExecutor.execute(responseData4));
        ...
        Assertions.assertFalse(rhythmixExecutor.execute(responseData5));
    }
    ...
    void testAcceptableResponseTimeRange() throws TranslatorException {
        ...
        Assertions.assertFalse(rhythmixExecutor.execute(responseData3));
        ...
        Assertions.assertFalse(rhythmixExecutor.execute(responseData6));
    }
    ...
    void testTimeoutResponseTimeRange() throws TranslatorException {
        ...
        Assertions.assertTrue(rhythmixExecutor.execute(responseData4));
    ...
    void testConsecutiveNormalResponseTime() throws TranslatorException {
        ...
        for (RhythmixEventData response : responses) {
            result = rhythmixExecutor.execute(response);
        }
    ...
    void testHumiditySensorValidRange() throws TranslatorException {
        ...
        Assertions.assertTrue(rhythmixExecutor.execute(humidityData4));
        ...
        Assertions.assertFalse(rhythmixExecutor.execute(humidityData5));

        // 测试超出范围105%，应该返回false
        RhythmixEventData humidityData6 = Util.genEventData("humidity6", "105", new Timestamp(System.currentTimeMillis()));
        Assertions.assertFalse(rhythmixExecutor.execute(humidityData6));
    }
    ...
    void testPressureSensorNormalRange() throws TranslatorException {
        ...
        Assertions.assertTrue(rhythmixExecutor.execute(pressureData1));
        ...
        Assertions.assertTrue(rhythmixExecutor.execute(pressureData2));
        ...
        Assertions.assertFalse(rhythmixExecutor.execute(pressureData3));
        ...
        Assertions.assertFalse(rhythmixExecutor.execute(pressureData4));
        ...
        Assertions.assertFalse(rhythmixExecutor.execute(pressureData5));
        ...
        Assertions.assertFalse(rhythmixExecutor.execute(pressureData6));
    }
    ...
    void testVoltageSensorWorkingRange() throws TranslatorException {
        ...
        Assertions.assertFalse(rhythmixExecutor.execute(voltageData4));
    ...
    void testCompoundSensorDetection() throws TranslatorException {
        ...
        Assertions.assertFalse(rhythmixExecutor.execute(sensorData1));
        ...
        Assertions.assertFalse(rhythmixExecutor.execute(sensorData4));
    }
    ...
    void testNormalTransactionAmountRange() throws TranslatorException {
        ...
        Assertions.assertFalse(rhythmixExecutor.execute(transactionData5));
        ...
        Assertions.assertFalse(rhythmixExecutor.execute(transactionData6));
    }
    ...
    void testSuspiciousTransactionAmountRange() throws TranslatorException {
        ...
        Assertions.assertFalse(rhythmixExecutor.execute(transactionData3));
    ...
    void testHighRiskTransactionAmountRange() throws TranslatorException {
        ...
        Assertions.assertFalse(rhythmixExecutor.execute(transactionData4));
    ...
    void testMemoryUsageWarningRange() throws TranslatorException {
        ...
        Assertions.assertFalse(rhythmixExecutor.execute(memoryData5));

        // 测试超出范围98%，应该返回false
        RhythmixEventData memoryData6 = Util.genEventData("memory6", "98", new Timestamp(System.currentTimeMillis()));
        Assertions.assertFalse(rhythmixExecutor.execute(memoryData6));
    }
    ...
    void testPrecisionSensitiveFloatRange() throws TranslatorException {
        ...
        Assertions.assertTrue(rhythmixExecutor.execute(data3));
