...
class FilterTest {
    ...
    void test3() throws LexicalException, TranslatorException, IOException, ParseException {
        ...
        SensorEvent p3 = Util.genPointData("1", "3", new Timestamp(System.currentTimeMillis()));
        SensorEvent p4 = Util.genPointData("1", "5", new Timestamp(System.currentTimeMillis()));
        SensorEvent p5 = Util.genPointData("1", "2", new Timestamp(System.currentTimeMillis()));
    ...
    void test10() throws LexicalException, TranslatorException, IOException, ParseException {
        ...
        SensorEvent p4 = Util.genPointData("1", "5", new Timestamp(System.currentTimeMillis()));
        SensorEvent p5 = Util.genPointData("1", "8", new Timestamp(System.currentTimeMillis()));
        SensorEvent p6 = Util.genPointData("1", "10", new Timestamp(System.currentTimeMillis()));
        boolean execute = executor.execute(p5);
        Assertions.assertFalse(execute);
        boolean execute1 = executor.execute(p3);
        Assertions.assertTrue(execute1);
