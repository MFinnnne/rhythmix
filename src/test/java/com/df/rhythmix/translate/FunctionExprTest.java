...
//        System.out.println(translate);
    ...
    void translate2() throws LexicalException, ParseException, TranslatorException {
        ...
        Executor translate = new Executor(translatedCode,env);
//        System.out.println(translate);
        EventData p1 = Util.genEventData("1", "5", new Timestamp(System.currentTimeMillis()));
        EventData p2 = Util.genEventData("1", "11", new Timestamp(System.currentTimeMillis()+110));
        EventData p3 = Util.genEventData("1", "9", new Timestamp(System.currentTimeMillis()));
