...
public class TestLogicalCompositeExpression {
    ...
    void testTemperatureAnomalyDetectionWithOR() throws TranslatorException {
        ...
        Assertions.assertFalse(executor.execute(tempData7));

        // 测试边界值40度，应该返回false
        RhythmixEventData tempData8 = Util.genEventData("temp8", "40", new Timestamp(System.currentTimeMillis()));
        Assertions.assertFalse(executor.execute(tempData8));
    }
    ...
    void testNetworkStatusAnomalyWithOR() throws TranslatorException {
        ...
        Assertions.assertTrue(executor.execute(networkData1));
        ...
        Assertions.assertTrue(executor.execute(networkData2));

        // 测试错误代码-1，应该返回true
        RhythmixEventData networkData3 = Util.genEventData("network3", "-1", new Timestamp(System.currentTimeMillis()));
        Assertions.assertTrue(executor.execute(networkData3));
        ...
        Assertions.assertFalse(executor.execute(networkData4));
        ...
        Assertions.assertFalse(executor.execute(networkData5));
        ...
        Assertions.assertFalse(executor.execute(networkData6));
    }
    ...
    void testDeviceFaultDetectionWithOR() throws TranslatorException {
        ...
        Assertions.assertTrue(executor.execute(voltageData4));
        ...
        Assertions.assertFalse(executor.execute(voltageData7));

        // 测试边界值5.0V，应该返回false
        RhythmixEventData voltageData8 = Util.genEventData("voltage8", "5.0", new Timestamp(System.currentTimeMillis()));
        Assertions.assertFalse(executor.execute(voltageData8));
    }
    ...
    void testNormalWorkingConditionsWithAND() throws TranslatorException {
        ...
        Assertions.assertTrue(executor.execute(conditionData1));
        ...
        Assertions.assertFalse(executor.execute(conditionData5));

        // 测试超出范围35度，应该返回false
        RhythmixEventData conditionData6 = Util.genEventData("condition6", "35", new Timestamp(System.currentTimeMillis()));
        Assertions.assertFalse(executor.execute(conditionData6));
    }
    ...
    void testSafeOperationStateWithAND() throws TranslatorException {
        ...
        Assertions.assertFalse(executor.execute(safetyData5));

        // 测试超出范围85，应该返回false
        RhythmixEventData safetyData6 = Util.genEventData("safety6", "85", new Timestamp(System.currentTimeMillis()));
        Assertions.assertFalse(executor.execute(safetyData6));
    }
    ...
    void testExcludeAnomalousValuesWithNOT() throws TranslatorException {
        ...
        Assertions.assertTrue(executor.execute(normalData1));
    ...
    void testEquipmentWarning() throws TranslatorException {
        ...
        Assertions.assertTrue(executor.execute(warningData1));
        ...
        Assertions.assertTrue(executor.execute(warningData2));

        // 测试压力过大160，应该返回true
        RhythmixEventData warningData3 = Util.genEventData("warning3", "160", new Timestamp(System.currentTimeMillis()));
        Assertions.assertTrue(executor.execute(warningData3));
        ...
        Assertions.assertTrue(executor.execute(warningData4));

        // 测试振动异常6.2，应该返回true
        RhythmixEventData warningData5 = Util.genEventData("warning5", "6.2", new Timestamp(System.currentTimeMillis()));
        Assertions.assertTrue(executor.execute(warningData5));
        ...
        Assertions.assertTrue(executor.execute(warningData6));
        ...
        Assertions.assertTrue(executor.execute(warningData7));
        ...
        Assertions.assertFalse(executor.execute(warningData8));
    }
    ...
    void testProductionLineNormalState() throws TranslatorException {
        ...
        Assertions.assertTrue(executor.execute(normalData4));
    ...
    void testSuspiciousTransactionDetection() throws TranslatorException {
        ...
        Assertions.assertTrue(executor.execute(transactionData5));
        ...
        Assertions.assertTrue(executor.execute(transactionData6));
        ...
        Assertions.assertTrue(executor.execute(transactionData7));
    }
    ...
    void testHighRiskAccountDetection() throws TranslatorException {
        ...
        Assertions.assertTrue(executor.execute(riskData1));
        ...
        Assertions.assertTrue(executor.execute(riskData2));
        ...
        Assertions.assertTrue(executor.execute(riskData3)); // 假设当前测试条件满足
        ...
        Assertions.assertFalse(executor.execute(riskData4));
    }
    ...
    void testPatientVitalSignsAbnormal() throws TranslatorException {
        ...
        Assertions.assertTrue(executor.execute(vitalData1));
    ...
    void testMedicalDeviceNormalOperation() throws TranslatorException {
        ...
        Assertions.assertFalse(executor.execute(deviceData5));
        ...
        Assertions.assertFalse(executor.execute(deviceData6));
    }
    ...
    void testAirQualityAlert() throws TranslatorException {
        ...
        Assertions.assertTrue(executor.execute(airData6));
    }
    ...
    void testComfortableEnvironment() throws TranslatorException {
        ...
        Assertions.assertFalse(executor.execute(comfortData5));
        ...
        Assertions.assertFalse(executor.execute(comfortData6));
    }
    ...
    void testComplexNestedLogic() throws TranslatorException {
        ...
        Assertions.assertTrue(executor.execute(complexData1));
        ...
        Assertions.assertTrue(executor.execute(complexData2));
        ...
        Assertions.assertTrue(executor.execute(complexData3));
        ...
        Assertions.assertTrue(executor.execute(complexData4));
        ...
        Assertions.assertFalse(executor.execute(complexData5));
    }
    ...
    void testDeviceFaultDiagnosis() throws TranslatorException {
        ...
        Assertions.assertFalse(executor.execute(faultData5));
    }
    ...
    void testMixedIntegerAndFloatLogic() throws TranslatorException {
        ...
        Assertions.assertTrue(executor.execute(mixedData1));
        ...
        Assertions.assertFalse(executor.execute(mixedData7));
    }
    ...
    void testHighPrecisionFloatLogic() throws TranslatorException {
        ...
        Assertions.assertFalse(executor.execute(precisionData4));
        ...
        Assertions.assertFalse(executor.execute(precisionData5));
        ...
        Assertions.assertFalse(executor.execute(precisionData6));
    }
}
