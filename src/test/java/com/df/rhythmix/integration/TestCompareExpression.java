...
public class TestCompareExpression {
    ...
    void testTemperatureGreaterThan30() throws TranslatorException {
        ...
        Assertions.assertTrue(rhythmixExecutor.execute(tempData));

        // 测试温度25度，应该返回false
        RhythmixEventData tempData2 = Util.genEventData("temp2", "25", new Timestamp(System.currentTimeMillis()));
        Assertions.assertFalse(rhythmixExecutor.execute(tempData2));
    ...
    void testProductWeightGreaterOrEqual100() throws TranslatorException {
        ...
        Assertions.assertTrue(rhythmixExecutor.execute(productData));
        ...
        Assertions.assertFalse(rhythmixExecutor.execute(productData3));
    }
    ...
    void testResponseTimeGreaterThan1000() throws TranslatorException {
        ...
        Assertions.assertTrue(rhythmixExecutor.execute(responseData));
        ...
        Assertions.assertFalse(rhythmixExecutor.execute(responseData2));
    ...
    void testPressureSensorEquals0() throws TranslatorException {
        ...
        Assertions.assertTrue(rhythmixExecutor.execute(sensorData));
    ...
    void testHumiditySensorNotEqualsNegative1() throws TranslatorException {
        ...
        Assertions.assertTrue(rhythmixExecutor.execute(sensorData3));
    }
    ...
    void testFloatingPointComparison() throws TranslatorException {
        ...
        Assertions.assertFalse(rhythmixExecutor.execute(data2));
